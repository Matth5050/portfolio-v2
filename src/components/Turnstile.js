    ...
    <>
      ...
      <div className="turnstile mt-5 flex justify-center ">
        <button
          ...
          className="group transition ease-in-out duration-500 border border-transparent hover:border-gray-800 hover:border rounded-md mt-5 mb-5 mr-4 h-screen sticky top-0"
        >
          <svg
            ...
            height="40"
            fill="currentColor"
            className="bi bi-chevron-left fill-white transition ease-in-out duration-500 group-hover:fill-gray-800"
            viewBox="0 0 16 16"
          >
            <path
              fill-rule="evenodd"
        ...
        <button
          onClick={() => handleNext()}
          className="rounded-md transition ease-in-out duration-500 border border-transparent group hover:border-gray-800 hover:border mt-5 mb-5 h-screen sticky top-0"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="40"
            height="40"
            fill="currentColor"
            className="bi bi-chevron-right fill-white transition ease-in-out duration-500 group-hover:fill-gray-800 "
            viewBox="0 0 16 16"
          >
            <path
              fill-rule="evenodd"
