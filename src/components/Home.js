...
export default function Home() {
  ...
  return (
    <div className="mt-5 md:mx-40 md:flex">
      <div className="overflow-hidden h-72 w-72 hidden md:block">
        <img className="rounded-full " src={me} alt="me!" />
      </div>
      <div className="overflow-hidden h-24 w-24 md:hidden">
        <img className="rounded-full " src={me} alt="me!" />
      </div>
      <div className="md:ml-10">
        <p className="mt-5 home-font text-xl font-bold text-white ">
          DevOps engineer, serverless enthusiast, and enjoyer of all things
          front end.
        </p>
